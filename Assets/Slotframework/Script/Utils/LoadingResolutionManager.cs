...
/// 直橫版型管理
/// </summary>
public class LoadingResolutionManager : Singleton<LoadingResolutionManager>
{
    /// <summary>
    /// 橫版物件
    /// </summary>
    ...
    {
        if (LandscapeUI == null && PoriraitUI == null)
        {
            return 0;
        }
        else if ((LandscapeUI != null && PoriraitUI == null) ||
                (LandscapeUI == null && PoriraitUI != null))
        {
            return 1;
        }
    ...
    public virtual void Init()
    {
        if (GetResolutionCount() > 1)
        {
            ...
            PoriraitUI.gameObject.SetActive(true);
        }
    ...
    private void SetCanvas()
    {
        ...
        if (currentIsLandscape)
        {
            ...
            PoriraitUI.planeDistance = -200;
        }
        else
        {
            LandscapeUI.planeDistance = -200;
            PoriraitUI.planeDistance = 100;
        }
    }
    ...
    public virtual bool CheckIsOn(Transform trans)
    {
        ...
        return (isLandscape && trans.root == LandscapeUI.transform) ||
                (!isLandscape && trans.root == PoriraitUI.transform);
    }
