...
public class Timer
{
    ...
    public Timer AddUpdateEvent(Action<float> onUpdate)
    {
        this._onUpdate += onUpdate;
        return this;
    }

    public Timer RomoveUpdateEvent(Action<float> onUpdate)
    {
    ...
    public Timer AddCompleteEvent(Action onComplete)
    {
        this._onComplete += onComplete;
        return this;
    }

    public Timer RomoveCompleteEvent(Action onComplete)
    {
    ...
    public Timer SetUsesRealTime(bool usesRealTime)
    {
        this.usesRealTime = usesRealTime;
        return this;
    }

    public Timer SetAutoDestroyOwner(MonoBehaviour autoDestroyOwner)
    {
