...
{
    public class EventRaised: AbstractLogFilter
    {
        public override int Order => 2;
        
        public override StyleLength Height => 50;
        
        [EditorPrefProp("GameEventHub_LogTool_EventRaised", true)]
        ...
        public override VisualElement DrawFilter()
        {
            ...
            var icon = UIToolkitHelpers.DrawUnityIcon("sv_icon_dot13_pix16_gizmo", "sv_icon_dot13_pix16_gizmo", 16,
                "filter-icon");
            rootFilterLine.Add(icon);

            var label = new Label("Event raised");
