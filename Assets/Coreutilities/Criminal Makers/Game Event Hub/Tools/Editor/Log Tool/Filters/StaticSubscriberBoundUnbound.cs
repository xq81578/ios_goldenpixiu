...
{
    public class StaticSubscriberBoundUnbound : AbstractLogFilter
    {
        public override int Order => 0;
        
        public override StyleLength Height => 50;

        [EditorPrefProp("GameEventHub_LogTool_StaticSubscriber", true)]
        ...
        public override bool EvaluateFilter(GameEvent gameEvent)
        {
            ...
            {
                OnObjectBoundToEventSystem { isStatic: true } => _isEnabled,
                OnObjectUnboundFromEventSystem { isStatic: true } => _isEnabled,
                _ => true
            };
        }
        ...
        public override VisualElement DrawFilter()
        {
            ...
            var icon = UIToolkitHelpers.DrawUnityIcon("sv_icon_dot9_pix16_gizmo", "sv_icon_dot9_pix16_gizmo", 16,
                "filter-icon");
            rootFilterLine.Add(icon);

            var label = new Label("Static subscriber bound/unbound");
