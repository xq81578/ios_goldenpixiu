...
public class ToggleButton : Image, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [SerializeField]
    private UnityEvent<bool> onToggle = new UnityEvent<bool>();
    ...
    [SerializeField]
    private UnityEvent<bool> onToggleReversed  = new UnityEvent<bool>();
    public UnityEvent<bool> OnToggleReversed
    {
        get { return OnToggleReversed ; }
        set { OnToggleReversed  = value; }
    }
